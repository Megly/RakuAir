        ...
        <body>
            ...
            　　 <li><p><i class="fa fa-map-marker fa-2x"></i>  : Current page you are lokking to. You can check how it works and details.</p></i></li>
              ...
              <!--</p>-->
               ...
               <p>There is a secret in this wonderful application.  That is, point system. We make points from -6 to 6 to calculate exact data we aime for.<br>
                  The points are basedn on sex and body characters and so on.</p>
